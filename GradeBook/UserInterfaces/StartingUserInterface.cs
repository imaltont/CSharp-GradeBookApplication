...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            {
                case "standard":
                    StandardGradeBook stGradeBook = new StandardGradeBook(name, isWeighted);
                    Console.WriteLine("Created gradebook {0}", name);
                    GradeBookUserInterface.CommandLoop(stGradeBook);
                    break;
                case "ranked":
                    RankedGradeBook rnkGradeBook = new RankedGradeBook(name, isWeighted);
                    Console.WriteLine("Created gradebook {0}", name);
